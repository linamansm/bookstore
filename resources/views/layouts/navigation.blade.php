    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('book.index')" :active="request()->routeIs('book.index')" class="text-black">
                        {{ __('Books') }}
                    </x-nav-link>
                </div>
                ...
                @if(auth()->user()->role === 'admin')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('book.create')" :active="request()->routeIs('book.create')" class="text-black">
                            {{ __('Add Books') }}
                        </x-nav-link>
                    </div>
                @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cart')" :active="request()->routeIs('cart')" class="text-black">
                        {{ __('Cart') }}
                    </x-nav-link>
                </div>
            </div>
